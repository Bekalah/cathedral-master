...
class SimpleCodexLibrary {
  ...
  loadNodes() {
    try {
      ...
      /* eslint-disable */console.error(...oo_tx(`3284225721_26_6_26_64_11`,'Error loading Codex nodes:', error.message));
      return {};
    }
  }
...
class SimpleLiberArcanae {
  ...
  loadCards() {
    try {
      ...
      /* eslint-disable */console.error(...oo_tx(`3284225721_63_6_63_65_11`,'Error loading Arcana cards:', error.message));
      return {};
    }
  }
...
For more information, visit: https://github.com/Bekalah/cathedral
  ...
  async handleCodex() {
    ...
    if (subcommand === 'search') {
      ...
      if (!query) {
        /* eslint-disable */console.log(...oo_oo(`3284225721_180_8_180_54_4`,'❌ Please provide a search query'));
        return;
      }

      /* eslint-disable */console.log(...oo_oo(`3284225721_184_6_184_55_4`,`🔍 Searching Codex for: "${query}"`));
      const results = this.codex.searchNodes(query);

      if (results.length === 0) {
        /* eslint-disable */console.log(...oo_oo(`3284225721_188_8_188_39_4`,'❌ No nodes found'));
        return;
      }

      results.forEach(node => {
        /* eslint-disable */console.log(...oo_oo(`3284225721_193_8_193_57_4`,`\n📍 Node ${node.id}: ${node.name}`));
        /* eslint-disable */console.log(...oo_oo(`3284225721_194_8_194_67_4`,`   Element: ${node.element} (${node.planet})`));
        /* eslint-disable */console.log(...oo_oo(`3284225721_195_8_195_48_4`,`   Chakra: ${node.chakra}`));
        /* eslint-disable */console.log(...oo_oo(`3284225721_196_8_196_56_4`,`   Theme: ${node.narrative.theme}`));
        /* eslint-disable */console.log(...oo_oo(`3284225721_197_8_197_73_4`,`   Keywords: ${node.narrative.keywords.join(', ')}`));
      });

    } else {
      const nodeId = parseInt(subcommand);
      if (!nodeId || nodeId < 1 || nodeId > 144) {
        /* eslint-disable */console.log(...oo_oo(`3284225721_203_8_203_63_4`,'❌ Please provide a valid node ID (1-144)'));
        return;
      }

      const node = this.codex.getNode(nodeId);
      if (!node) {
        /* eslint-disable */console.log(...oo_oo(`3284225721_209_8_209_49_4`,`❌ Node ${nodeId} not found`));
        return;
      }

      /* eslint-disable */console.log(...oo_oo(`3284225721_213_6_213_61_4`,`\n📍 Codex Node ${node.id}: ${node.name}`));
      /* eslint-disable */console.log(...oo_oo(`3284225721_214_6_214_82_4`,`   Element: ${node.element} (${node.planet} - ${node.zodiac})`));
      /* eslint-disable */console.log(...oo_oo(`3284225721_215_6_215_46_4`,`   Chakra: ${node.chakra}`));
      /* eslint-disable */console.log(...oo_oo(`3284225721_216_6_216_54_4`,`   Solfeggio: ${node.solfeggio}Hz`));
      /* eslint-disable */console.log(...oo_oo(`3284225721_217_6_217_44_4`,`   Color: ${node.color}`));
      /* eslint-disable */console.log(...oo_oo(`3284225721_218_6_218_50_4`,`   Geometry: ${node.geometry}`));
      /* eslint-disable */console.log(...oo_oo(`3284225721_219_6_219_43_4`,`   Angel: ${node.shem}`));
      /* eslint-disable */console.log(...oo_oo(`3284225721_220_6_220_45_4`,`   Demon: ${node.goetia}`));
      /* eslint-disable */console.log(...oo_oo(`3284225721_221_6_221_54_4`,`   Theme: ${node.narrative.theme}`));
      /* eslint-disable */console.log(...oo_oo(`3284225721_222_6_222_62_4`,`   Archetype: ${node.narrative.archetype}`));
      /* eslint-disable */console.log(...oo_oo(`3284225721_223_6_223_71_4`,`   Keywords: ${node.narrative.keywords.join(', ')}`));
    }
  }
  ...
  async handleArcanae() {
    ...
    if (subcommand === 'search') {
      const query = process.argv[4];
      if (!query) {
        /* eslint-disable */console.log(...oo_oo(`3284225721_233_8_233_54_4`,'❌ Please provide a search query'));
        return;
      }

      /* eslint-disable */console.log(...oo_oo(`3284225721_237_6_237_57_4`,`🔍 Searching Arcanae for: "${query}"`));
      const results = this.arcanae.searchCards(query);

      if (results.length === 0) {
        /* eslint-disable */console.log(...oo_oo(`3284225721_241_8_241_39_4`,'❌ No cards found'));
        return;
      }

      results.forEach(card => {
        /* eslint-disable */console.log(...oo_oo(`3284225721_246_8_246_57_4`,`\n🃏 ${card.name} (${card.number})`));
        /* eslint-disable */console.log(...oo_oo(`3284225721_247_8_247_50_4`,`   Element: ${card.element}`));
        /* eslint-disable */console.log(...oo_oo(`3284225721_248_8_248_77_4`,`   Specializations: ${card.specializations.join(', ')}`));
        /* eslint-disable */console.log(...oo_oo(`3284225721_249_8_249_56_4`,`   Status: ${card.faculty_status}`));
      });

    } else {
      const cardId = subcommand;
      if (!cardId) {
        /* eslint-disable */console.log(...oo_oo(`3284225721_255_8_255_49_4`,'❌ Please provide a card ID'));
        return;
      }

      const card = this.arcanae.getCard(cardId);
      if (!card) {
        /* eslint-disable */console.log(...oo_oo(`3284225721_261_8_261_49_4`,`❌ Card ${cardId} not found`));
        return;
      }

      /* eslint-disable */console.log(...oo_oo(`3284225721_265_6_265_55_4`,`\n🃏 ${card.name} (${card.number})`));
      /* eslint-disable */console.log(...oo_oo(`3284225721_266_6_266_44_4`,`   Title: ${card.title}`));
      /* eslint-disable */console.log(...oo_oo(`3284225721_267_6_267_48_4`,`   Element: ${card.element}`));
      /* eslint-disable */console.log(...oo_oo(`3284225721_268_6_268_54_4`,`   Status: ${card.faculty_status}`));
      /* eslint-disable */console.log(...oo_oo(`3284225721_269_6_269_54_4`,`   Department: ${card.department}`));
      /* eslint-disable */console.log(...oo_oo(`3284225721_270_6_270_75_4`,`   Specializations: ${card.specializations.join(', ')}`));
      /* eslint-disable */console.log(...oo_oo(`3284225721_271_6_271_69_4`,`   Teaching Focus: ${card.powers.teaching_focus}`));
    }
  }

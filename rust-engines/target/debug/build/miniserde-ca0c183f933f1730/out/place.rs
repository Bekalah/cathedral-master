...
macro_rules! make_place {
    ($name:ident) => {
        #[repr(C)]
        struct $name<__T> {
            out: $crate::__private43::Option<__T>,
        }

        impl<__T> $name<__T> {
            fn new(out: &mut $crate::__private43::Option<__T>) -> &mut Self {
                unsafe { &mut *(out as *mut $crate::__private43::Option<__T> as *mut $name<__T>) }
            }
        }
    };
}

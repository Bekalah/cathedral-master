...
export type CodexCategory = 'alchemy' | 'sacred-geometry' | 'mystery-traditions' | 'consciousness' | 'esoteric-philosophy' | 'mystical-mathematics' | 'occult-sciences' | 'spiritual-practices';

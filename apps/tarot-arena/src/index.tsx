  ...
  return (
    <div
      ...
      <div style={{ padding: 16 }}>
        ...
        <div style={{ fontSize: 15, color: avatar.color }}>
          {avatar.sound} • {avatar.resonance} Hz
        </div>
      ...
      {showLore && (
        <div
          ...
          <div style={{ fontSize: 13, color: "#ffd700", marginBottom: 8 }}>
            Source: {avatar.citation}
          </div>
...
function TarotArena() {
  ...
  function getPowersFromAvatar(avatar: any) {
    ...
    return (
      powersMap[avatar.name] || ["Consciousness Enhancement", "Wisdom Sharing"]
    );
  }
    ...
    <>
      ...
      <div
        ...
        <p
          ...
          Select Arcana avatars to team up, duel, or create living art. Hover
          for lore. All actions are ND/trauma-safe and research-based.
        </p>
        <div
          style={{
            display: "flex",
        ...
        <div
          ...
          <button
            onClick={() =>
              selected.length > 0 && summonTarotCreature(selected[0])
            }
            disabled={selected.length === 0}
            style={{
              padding: "12px 24px",
          ...
          <button
            onClick={() =>
              selected.length > 0 && createAvalonRealm(selected[0])
            }
            disabled={selected.length === 0}
            style={{
              padding: "12px 24px",
        ...
        <div
          ...
          <h2 style={{ fontSize: 28, color: "#ffd700", marginBottom: 16 }}>
            Battle/Art Log
          </h2>
        ...
        {showAvalonInterface && currentRealm && (
          <div
            ...
            <div
              ...
              <h2 style={{ fontSize: 32, color: "#ffd700", margin: 0 }}>
                🏰 {currentRealm.name}
              </h2>
              <button
            ...
            <div
              ...
              <div
                ...
                <h3
                  style={{ color: "#8b5a8c", fontSize: 20, marginBottom: 12 }}>
                  🏛️ Architecture
                </h3>
                <p style={{ fontSize: 14, color: "#fff", marginBottom: 8 }}>
                  <strong>Structure:</strong>{" "}
                  {currentRealm.template.architecture.structure}
                </p>
                <p style={{ fontSize: 14, color: "#fff", marginBottom: 8 }}>
                  <strong>Sacred Geometry:</strong>{" "}
                  {currentRealm.template.architecture.sacred_geometry.join(
                    ", "
                  )}
                </p>
                <p style={{ fontSize: 14, color: "#fff" }}>
                  <strong>Colors:</strong>{" "}
                  {currentRealm.template.architecture.colors.join(", ")}
                </p>
              </div>
              ...
              <div
                ...
                <h3
                  style={{ color: "#7fb069", fontSize: 20, marginBottom: 12 }}>
                  ✨ Magical Features
                </h3>
                <ul style={{ fontSize: 14, color: "#fff", margin: 0 }}>
                  {currentRealm.magical_features
                    .slice(0, 3)
              ...
              {activeCreatures.map((creature) => (
                <div
                  ...
                  style={{
                    ...
                    boxShadow: "0 0 16px rgba(139,90,140,0.3)",
                  }}>
                  <h3
                    style={{ color: "#ffd700", fontSize: 18, marginBottom: 8 }}>
                    {creature.name}
                  </h3>
                  <p
                    style={{ fontSize: 12, color: "#8b5a8c", marginBottom: 8 }}>
                    <strong>Archetype:</strong> {creature.tarot_archetype.name}
                  </p>
                  <p style={{ fontSize: 12, color: "#aaa", marginBottom: 12 }}>
                    <strong>Element:</strong>{" "}
                    {creature.elemental_base.energy_pattern}
                  </p>
                  <p
                    style={{
                      fontSize: 12,
                  ...
                  <div style={{ fontSize: 11, color: "#7fb069" }}>
                    ...
                    {creature.abilities.basic.slice(0, 2).join(", ")}
                  </div>
                  <div style={{ fontSize: 11, color: "#4a90e2", marginTop: 8 }}>
                    <strong>Evolution:</strong> Level{" "}
        ...
        <div
          ...
          <p style={{ fontSize: 16, color: "#aaa", marginBottom: 12 }}>
            Each avatar has unique lore. You can add your own below:
          </p>
          <textarea
            style={{
              width: "100%",
